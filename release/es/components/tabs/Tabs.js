...
var Tabs = function (_Component) {
  ...
  Tabs.prototype.render = function render() {
    ...
    var addButton = editable || addable ? React.createElement(
      ...
      React.createElement('i', { className: 'ko-icon-plus' })
    ) : null;
    var scrollBtn = scrollable ? [React.createElement(
      ...
      React.createElement('i', { className: 'ko-icon-arrow-left' })
    ), React.createElement(
      'span',
      ...
      React.createElement('i', { className: 'ko-icon-arrow-right' })
    )] : null;
    this.tabs = [];
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.Children.map(children, function (item, index) {
                ...
                return React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement('span', { className: 'ko-icon-close', onClick: function onClick(e) {
              ...
              React.createElement(
                View,
                { show: !type },
                React.createElement('div', { className: 'ko-tabs__active-bar', style: barStyle })
              )
            )
          )
        )
