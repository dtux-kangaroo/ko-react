...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Button, 'Button', 'src/components/button/button.jsx');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/button/button.jsx');
}();
