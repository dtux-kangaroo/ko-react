  ...
  (0, _createClass3.default)(DialogBody, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { style: this.style(), className: this.className('ko-dialog__body') },
        this.props.children
      );
    }
  }]);
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(DialogBody, 'DialogBody', 'src/components/dialog/dialogBody.jsx');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/dialog/dialogBody.jsx');
}();
