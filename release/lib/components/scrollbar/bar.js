...
var _dom = require('../../utils/tool/dom.js');
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        {
          ...
          className: this.classNames('ko-scrollbar__bar', 'is-' + this.bar.key),
          onMouseDown: this.clickTrackHandler },
        _react2.default.createElement('div', {
          ref: function ref(thumb) {
            return _this2.thumbRef = thumb;
          },
          className: 'ko-scrollbar__thumb',
...
Bar.propTypes = {
  ...
  move: _utils.PropTypes.number,
  getParentWrap: _utils.PropTypes.func.isRequired
};
;
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Bar, 'Bar', 'src/components/scrollbar/bar.jsx');
}();
