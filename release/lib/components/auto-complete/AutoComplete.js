...
var AutoComplete = function (_Component) {
  ...
  (0, _createClass3.default)(AutoComplete, [{
    ...
    value: function highlight(index) {
      ...
      if (reference instanceof HTMLElement) {
        var suggestion = document.querySelector('.ko-autocomplete-suggestion__wrap');
        var suggestionList = document.querySelectorAll('.ko-autocomplete-suggestion__list li');
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { style: this.style(), className: this.className('ko-autocomplete') },
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(AutoComplete, 'AutoComplete', 'src/components/auto-complete/AutoComplete.jsx');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/auto-complete/AutoComplete.jsx');
}();
