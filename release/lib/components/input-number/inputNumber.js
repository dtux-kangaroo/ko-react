  ...
  (0, _createClass3.default)(InputNumber, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { style: this.style(), className: this.className('ko-input-number', size && 'ko-input-number--' + size, {
        ...
        controls && _react2.default.createElement(
          'span',
          {
            className: this.classNames("ko-input-number__decrease", {
              'is-disabled': this.minDisabled
            }),
            onClick: this.decrease.bind(this)
          },
          _react2.default.createElement('i', { className: 'ko-icon-minus' })
        ),
        controls && _react2.default.createElement(
          'span',
          {
            className: this.classNames("ko-input-number__increase", {
...
InputNumber.propTypes = {
  defaultValue: _utils.PropTypes.number,
  value: _utils.PropTypes.number,
  step: _utils.PropTypes.oneOfType([_utils.PropTypes.number, _utils.PropTypes.string]),
  max: _utils.PropTypes.oneOfType([_utils.PropTypes.number, _utils.PropTypes.string]),
  min: _utils.PropTypes.oneOfType([_utils.PropTypes.number, _utils.PropTypes.string]),
  disabled: _utils.PropTypes.bool,
  controls: _utils.PropTypes.bool,
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(InputNumber, 'InputNumber', 'src/components/input-number/inputNumber.jsx');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/input-number/inputNumber.jsx');
}();
