...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(OptionGroup, 'OptionGroup', 'src/components/select/optionGroup.jsx');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/select/optionGroup.jsx');
}();
