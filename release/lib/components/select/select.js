...
var _style = require('../../utils/tool/style');
...
var Select = function (_Component) {
  ...
  function Select(props) {
    ...
    _this.state = {
      ...
      cachedPlaceHolder: props.placeholder || _locales2.default.t('ko.select.placeholder'),
      currentPlaceholder: props.placeholder || _locales2.default.t('ko.select.placeholder'),
      selectedLabel: '',
      selectedInit: false,
      visible: false,
      selected: undefined,
  ...
  (0, _createClass3.default)(Select, [{
    ...
    value: function onVisibleChange(visible) {
      ...
      if (!visible) {
        ...
        if (this.refs.root.querySelector('.ko-input__icon')) {
          var elements = this.refs.root.querySelector('.ko-input__icon');
        ...
        var icon = this.refs.root.querySelector('.ko-input__icon');

        if (icon && !icon.classList.contains('ko-icon-circle-close')) {
          var _elements = this.refs.root.querySelector('.ko-input__icon');
    ...
    value: function emptyText() {
      ...
      if (loading) {
        return _locales2.default.t('ko.select.loading');
      } else {
        if (voidRemoteQuery) {
        ...
        if (filterable && filteredOptionsCount === 0) {
          return _locales2.default.t('ko.select.noMatch');
        }

        if (options.length === 0) {
          return _locales2.default.t('ko.select.noData');
        }
      }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { ref: 'root', style: this.style(), className: this.className('ko-select') },
        multiple && _react2.default.createElement(
          'div',
          { ref: 'tags', className: 'ko-select__tags', onClick: this.toggleMenu.bind(this), style: {
          ...
          selected.map(function (el) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                'span',
                { className: 'ko-select__tags-text' },
                el.currentLabel()
              )
            );
          }),
          filterable && _react2.default.createElement('input', {
            ref: 'input',
            type: 'text',
            className: this.classNames('ko-select__input', size && 'is-' + size),
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { ref: 'popper', className: this.classNames('ko-select-dropdown', {
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  {
                    viewComponent: 'ul',
                    wrapClass: 'ko-select-dropdown__wrap',
                    viewClass: 'ko-select-dropdown__list'
                  },
                  this.props.children
                )
              ),
              this.emptyText() && _react2.default.createElement(
                'p',
                { className: 'ko-select-dropdown__empty' },
                this.emptyText()
              )
            )
          )
...
Select.propTypes = {
  ...
  clearable: _utils.PropTypes.bool,
  filterable: _utils.PropTypes.bool,
  loading: _utils.PropTypes.bool,
  remote: _utils.PropTypes.bool,
  remoteMethod: _utils.PropTypes.func,
  filterMethod: _utils.PropTypes.func,
  multiple: _utils.PropTypes.bool,
  placeholder: _utils.PropTypes.string,
  onChange: _utils.PropTypes.func,
  onVisibleChange: _utils.PropTypes.func,
  onRemoveTag: _utils.PropTypes.func,
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(sizeMap, 'sizeMap', 'src/components/select/select.jsx');

  __REACT_HOT_LOADER__.register(Select, 'Select', 'src/components/select/select.jsx');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/select/select.jsx');
}();
