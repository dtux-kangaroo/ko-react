    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          {
            style: this.style(),
            className: this.className('ko-select-dropdown__item', {
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Option, 'Option', 'src/components/select/option.jsx');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/select/option.jsx');
}();
