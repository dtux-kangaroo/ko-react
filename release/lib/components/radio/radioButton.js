  ...
  (0, _createClass3.default)(RadioButton, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'label',
        { style: this.style(), className: this.className('ko-radio-button', this.props.size && 'ko-radio-button--' + this.size(), {
        ...
        _react2.default.createElement(
          'span',
          { className: 'ko-radio-button__inner', style: this.state.checked ? this.activeStyle() : {} },
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(RadioButton, 'RadioButton', 'src/components/radio/radioButton.jsx');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/radio/radioButton.jsx');
}();
