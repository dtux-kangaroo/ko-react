...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(RadioGroup, 'RadioGroup', 'src/components/radio/RadioGroup.jsx');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/radio/RadioGroup.jsx');
}();
