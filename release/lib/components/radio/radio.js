  ...
  (0, _createClass3.default)(Radio, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'label',
        { style: this.style(), className: this.className('ko-radio') },
        _react2.default.createElement(
          ...
          _react2.default.createElement('span', { className: 'ko-radio__inner' }),
...
Radio.propTypes = {
  value: _utils.PropTypes.oneOfType([_utils.PropTypes.string, _utils.PropTypes.number]).isRequired,
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Radio, 'Radio', 'src/components/radio/radio.jsx');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/radio/radio.jsx');
}();
