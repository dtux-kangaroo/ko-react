  ...
  (0, _createClass3.default)(CheckboxButton, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'label',
        { style: this.style(), className: this.className('ko-checkbox-button', group.props.size ? 'ko-checkbox-button--' + group.props.size : '', {
            'is-disabled': this.props.disabled,
            'is-checked': this.state.checked,
            'is-focus': this.state.focus
          }) },
        _react2.default.createElement('input', {
          className: 'ko-checkbox-button__original',
          type: 'checkbox',
        ...
        _react2.default.createElement(
          'span',
          { className: 'ko-checkbox-button__inner', style: this.state.checked ? {
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(CheckboxButton, 'CheckboxButton', 'src/components/checkbox/CheckBoxButton.jsx');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/checkbox/CheckBoxButton.jsx');
}();
