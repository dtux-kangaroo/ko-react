  ...
  (0, _createClass3.default)(Tabs, [{
    ...
    value: function render() {
      ...
      var tabsCls = this.classNames({
        'ko-tabs': true,
        'ko-tabs--card': type === 'card',
        'ko-tabs--border-card': type === 'border-card'
      });
      var addButton = editable || addable ? _react2.default.createElement(
        'span',
        {
          className: 'ko-tabs__new-tab',
          onClick: function onClick() {
            return _this5.handleTabAdd();
          }
        },
        _react2.default.createElement('i', { className: 'ko-icon-plus' })
      ) : null;
      var scrollBtn = scrollable ? [_react2.default.createElement(
        'span',
        { key: 'ko-tabs__nav-prev',
          className: scrollable.prev ? 'ko-tabs__nav-prev' : 'ko-tabs__nav-prev is-disabled',
          onClick: function onClick() {
            return _this5.scrollPrev();
          }
        },
        _react2.default.createElement('i', { className: 'ko-icon-arrow-left' })
      ), _react2.default.createElement(
        'span',
        { key: 'ko-tabs__nav-next',
          className: scrollable.next ? 'ko-tabs__nav-next' : 'ko-tabs__nav-next is-disabled',
          onClick: function onClick() {
            return _this5.scrollNext();
          }
        },
        _react2.default.createElement('i', { className: 'ko-icon-arrow-right' })
      )] : null;
      this.tabs = [];
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'ko-tabs__header' },
          addButton,
          _react2.default.createElement(
            'div',
            { className: scrollable ? 'ko-tabs__nav-wrap is-scrollable' : 'ko-tabs__nav-wrap' },
            scrollBtn,
            _react2.default.createElement(
              'div',
              { className: 'ko-tabs__nav-scroll', ref: 'navScroll' },
              _react2.default.createElement(
                'div',
                { className: 'ko-tabs__nav', ref: 'nav', style: navStyle },
                _react2.default.Children.map(children, function (item, index) {
                  ...
                  return _react2.default.createElement(
                    'div',
                    { key: 'ko-tabs__item-' + index, ref: function ref(tab) {
                    ...
                    _react2.default.createElement(
                      ...
                      _react2.default.createElement('span', { className: 'ko-icon-close', onClick: function onClick(e) {
                ...
                _react2.default.createElement(
                  _utils.View,
                  { show: !type },
                  _react2.default.createElement('div', { className: 'ko-tabs__active-bar', style: barStyle })
                )
              )
            )
          )
...
Tabs.propTypes = {
  type: _utils.PropTypes.oneOf(['card', 'border-card']),
  activeName: _utils.PropTypes.string,
  value: _utils.PropTypes.string,
  closable: _utils.PropTypes.bool,
  addable: _utils.PropTypes.bool,
  editable: _utils.PropTypes.bool,
  onTabClick: _utils.PropTypes.func,
  onTabRemove: _utils.PropTypes.func,
  onTabAdd: _utils.PropTypes.func,
  onTabEdit: _utils.PropTypes.func
};
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Tabs, 'Tabs', 'src/components/tabs/Tabs.jsx');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/tabs/Tabs.jsx');
}();
