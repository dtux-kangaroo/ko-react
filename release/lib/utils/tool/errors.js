...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(ExtendableError, 'ExtendableError', 'src/utils/tool/errors.js');

  __REACT_HOT_LOADER__.register(MethodImplementationRequiredError, 'MethodImplementationRequiredError', 'src/utils/tool/errors.js');
}();
