...
var _popperMixins = require('./popperMixins');
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(watchPropertyChange, 'watchPropertyChange', 'src/utils/tool/index.js');

  __REACT_HOT_LOADER__.register(createPropType, 'createPropType', 'src/utils/tool/index.js');

  __REACT_HOT_LOADER__.register(hashCode, 'hashCode', 'src/utils/tool/index.js');

  __REACT_HOT_LOADER__.register(pick, 'pick', 'src/utils/tool/index.js');

  __REACT_HOT_LOADER__.register(range, 'range', 'src/utils/tool/index.js');
}();
