...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(ErrorConditionFailed, 'ErrorConditionFailed', 'src/utils/tool/assert.js');

  __REACT_HOT_LOADER__.register(require_condition, 'require_condition', 'src/utils/tool/assert.js');
}();
