...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(mixinPrototype, 'mixinPrototype', 'src/utils/tool/popperMixins.js');

  __REACT_HOT_LOADER__.register(PopperMixin, 'PopperMixin', 'src/utils/tool/popperMixins.js');

  __REACT_HOT_LOADER__.register(PopperReactMixinMethods, 'PopperReactMixinMethods', 'src/utils/tool/popperMixins.js');

  __REACT_HOT_LOADER__.register(PopperReactMixin, 'PopperReactMixin', 'src/utils/tool/popperMixins.js');
}();
