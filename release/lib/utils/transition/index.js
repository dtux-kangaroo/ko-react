...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Transition, 'Transition', 'src/utils/transition/index.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/utils/transition/index.js');
}();
