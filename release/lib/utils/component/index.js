...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Component, 'Component', 'src/utils/component/index.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/utils/component/index.js');
}();
