...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(windowKey, 'windowKey', 'src/utils/internal/eventRegister.jsx');

  __REACT_HOT_LOADER__.register(registerMap, 'registerMap', 'src/utils/internal/eventRegister.jsx');

  __REACT_HOT_LOADER__.register(not_null, 'not_null', 'src/utils/internal/eventRegister.jsx');

  __REACT_HOT_LOADER__.register(hasRegistered, 'hasRegistered', 'src/utils/internal/eventRegister.jsx');

  __REACT_HOT_LOADER__.register(cleanRegister, 'cleanRegister', 'src/utils/internal/eventRegister.jsx');

  __REACT_HOT_LOADER__.register(doRegister, 'doRegister', 'src/utils/internal/eventRegister.jsx');

  __REACT_HOT_LOADER__.register(EventRegister, 'EventRegister', 'src/utils/internal/eventRegister.jsx');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/utils/internal/eventRegister.jsx');
}();
