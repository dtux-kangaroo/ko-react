...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(ANIMATION_DURATION, 'ANIMATION_DURATION', 'src/utils/collapse/index.jsx');

  __REACT_HOT_LOADER__.register(CollapseTransition, 'CollapseTransition', 'src/utils/collapse/index.jsx');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/utils/collapse/index.jsx');
}();
