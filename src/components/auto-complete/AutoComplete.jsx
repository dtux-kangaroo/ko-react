...
class AutoComplete extends Component {
  ...
  highlight(index: number): void {
    ...
    if (reference instanceof HTMLElement) {
      const suggestion = document.querySelector('.ko-autocomplete-suggestion__wrap');
      const suggestionList = document.querySelectorAll('.ko-autocomplete-suggestion__list li');
  ...
  render(): React.Element<any> {
    ...
    return (
      <div style={this.style()} className={this.className('ko-autocomplete')}>
        <Input
