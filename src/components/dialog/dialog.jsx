...
import { Component, View, Transition, PropTypes } from '../../utils';
        ...
        <Transition name="dialog-fade">
          <View show={ visible }>
            ...
            >
              ...
              >
                <div className="ko-dialog__header">
                  <span className="ko-dialog__title">{ title }</span>
                  {
                    showClose && (
                      <button type="button" className="ko-dialog__headerbtn" onClick={ e => this.close(e)} >
                        <i className="ko-dialog__close ko-icon ko-icon-close"></i>
                      </button>
                    )
                  }
                </div>
