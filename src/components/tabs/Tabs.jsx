...
import { Component, PropTypes, View } from '../../utils';
  ...
  render(): React.Element<any> {
    ...
    return (
      <div style={this.style()} className={this.className(tabsCls)}>
        <div className="ko-tabs__header">
          {addButton}
          <div className={scrollable ? 'ko-tabs__nav-wrap is-scrollable' : 'ko-tabs__nav-wrap'}>
            {scrollBtn}
            <div className="ko-tabs__nav-scroll" ref="navScroll">
              <div className="ko-tabs__nav" ref="nav" style={navStyle}>
                {
                  React.Children.map(children, (item, index) => {
                    ...
                    return (
                      <div key={ `ko-tabs__item-${index}` } ref={ (tab) => tab && this.tabs.push(tab) } name={ name } className={ tabCls } onClick={ (e) => this.handleTabClick(item, e) }>
                        { label }
                        <View show={ editable || closable || item.props.closable }>
                          <span className="ko-icon-close" onClick={ (e) => this.handleTabRemove(item, index, e) }></span>
                        </View>
                      </div>
                    )
                  })
                ...
                <View show={ !type }>
                  <div className="ko-tabs__active-bar" style={ barStyle }></div>
                </View>
              </div>
            </div>
          </div>
        </div>
        <div className="ko-tabs__content">
          {
