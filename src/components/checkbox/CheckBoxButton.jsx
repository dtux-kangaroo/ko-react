...
export default class CheckboxButton extends CheckBox {
  ...
  render(): React.Element<any> {
    ...
    return (
      <label style={this.style()} className={this.className('ko-checkbox-button', group.props.size ? 'ko-checkbox-button--' + group.props.size : '', {
        ...
        />
        <span className="ko-checkbox-button__inner" style={this.state.checked ? {
