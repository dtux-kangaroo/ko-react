...
export default class Checkbox extends Component {
  ...
  render(): React.Element<any> {
    return (
      <label style={this.style()} className={this.className('ko-checkbox')}>
        <span className={this.classNames('ko-checkbox__input', {
          'is-disabled': this.props.disabled,
          'is-checked': this.state.checked,
          'is-indeterminate': this.props.indeterminate,
          'is-focus': this.state.focus
        })}>
          <span className="ko-checkbox__inner"></span>
          <input
        ...
        <span className="ko-checkbox__label">
